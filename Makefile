...
ubuntu-16.04: ubuntu-16.04-compress ubuntu-16.04-upload

ubuntu-16.04-compress:
	qemu-img convert -O qcow2 -c ./ubuntu-16.04-amd64 ./ubuntu-16.04-amd64-compressed.qcow2

ubuntu-16.04-upload:
	openstack image create --min-disk 20 --disk-format qcow2 --file ./ubuntu-16.04-amd64-compressed.qcow2 bento-base-ubuntu-16.04-amd
